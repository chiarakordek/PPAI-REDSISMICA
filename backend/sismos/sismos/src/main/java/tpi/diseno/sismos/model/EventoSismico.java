// Archivo completo, final y con el mapeo reforzado para: model/EventoSismico.java
...
public class EventoSismico {
    ...
    // Hacemos el mapeo más explícito para evitar problemas.
    // FetchType.EAGER le dice a Hibernate: "Cuando cargues un EventoSismico, SIEMPRE carga su Estado asociado inmediatamente".
    ...
    public void setEstado(Estado estadoActual) { this.estadoActual = estadoActual; }
